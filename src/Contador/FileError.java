 ...
 * @author User
 */
public class FileError extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(442, 180));
        setResizable(false);
        ...
        jLabel4.setText("Não foi possivel gerar o relarótório!");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(140, 30, 290, 20);

        jLabel5.setFont(new java.awt.Font("Microsoft YaHei UI", 0, 12)); // NOI18N
        jLabel5.setText("Verifique se existe outro arquivo de relarório");
        ...
        jButton1.setBounds(350, 100, 73, 30);

        jLabel8.setFont(new java.awt.Font("Microsoft YaHei UI", 0, 12)); // NOI18N
        jLabel8.setText("aberto e tente novamente.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FileError.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
